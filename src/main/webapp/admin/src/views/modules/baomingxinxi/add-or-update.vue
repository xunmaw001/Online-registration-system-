<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考试名称" prop="kaoshimingcheng">
          <el-input v-model="ruleForm.kaoshimingcheng" 
              placeholder="考试名称" clearable  :readonly="ro.kaoshimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考试名称" prop="kaoshimingcheng">
              <el-input v-model="ruleForm.kaoshimingcheng" 
                placeholder="考试名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考试时间" prop="kaoshishijian">
          <el-input v-model="ruleForm.kaoshishijian" 
              placeholder="考试时间" clearable  :readonly="ro.kaoshishijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考试时间" prop="kaoshishijian">
              <el-input v-model="ruleForm.kaoshishijian" 
                placeholder="考试时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="考生号" prop="kaoshenghao">
            <el-input v-model="ruleForm.kaoshenghao" 
                placeholder="考生号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaoshenghao" label="考生号" prop="kaoshenghao">
              <el-input v-model="ruleForm.kaoshenghao" 
                placeholder="考生号" readonly></el-input>
          </el-form-item>
        </div>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报考费用" prop="baokaofeiyong">
          <el-input v-model="ruleForm.baokaofeiyong" 
              placeholder="报考费用" clearable  :readonly="ro.baokaofeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报考费用" prop="baokaofeiyong">
              <el-input v-model="ruleForm.baokaofeiyong" 
                placeholder="报考费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考试地址" prop="kaoshidizhi">
          <el-input v-model="ruleForm.kaoshidizhi" 
              placeholder="考试地址" clearable  :readonly="ro.kaoshidizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考试地址" prop="kaoshidizhi">
              <el-input v-model="ruleForm.kaoshidizhi" 
                placeholder="考试地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="专业名称" prop="zhuanyemingcheng">
              <el-input v-model="ruleForm.zhuanyemingcheng" 
                placeholder="专业名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考生账号" prop="kaoshengzhanghao">
          <el-input v-model="ruleForm.kaoshengzhanghao" 
              placeholder="考生账号" clearable  :readonly="ro.kaoshengzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考生账号" prop="kaoshengzhanghao">
              <el-input v-model="ruleForm.kaoshengzhanghao" 
                placeholder="考生账号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考生姓名" prop="kaoshengxingming">
          <el-input v-model="ruleForm.kaoshengxingming" 
              placeholder="考生姓名" clearable  :readonly="ro.kaoshengxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考生姓名" prop="kaoshengxingming">
              <el-input v-model="ruleForm.kaoshengxingming" 
...
export default {
  data() {
	...
	kaoshengzhanghao : false,
	kaoshengxingming : false,
	xingbie : false,
	zhuanye : false,
	shengfen : false,
	xuexiao : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kaoshishijian = true;
            continue;
	            	            ...
	            	            if(o=='kaoshenghao'){
            this.ruleForm.kaoshenghao = obj[o];
	    this.ro.kaoshenghao = true;
            continue;
          }
	            	            if(o=='baokaofeiyong'){
            this.ruleForm.baokaofeiyong = obj[o];
	    this.ro.baokaofeiyong = true;
            continue;
          }
	            	            if(o=='kaoshidizhi'){
            this.ruleForm.kaoshidizhi = obj[o];
	    this.ro.kaoshidizhi = true;
            continue;
          }
	    ...
	    this.ro.kaoshengzhanghao = true;
            continue;
          }
	            	            if(o=='kaoshengxingming'){
            this.ruleForm.kaoshengxingming = obj[o];
	    this.ro.kaoshengxingming = true;
            continue;
          }
	            	            if(o=='xingbie'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
                                                                                                                                                          		if(json.kaoshengzhanghao!=''&&json.kaoshengzhanghao){
              		this.ruleForm.kaoshengzhanghao = json.kaoshengzhanghao
		}
                                  		if(json.kaoshengxingming!=''&&json.kaoshengxingming){
              		...
              		this.ruleForm.zhuanye = json.zhuanye
                                  		...
                                  		if(json.shengfen!=''&&json.shengfen){
              		this.ruleForm.shengfen = json.shengfen
		}
                                  		if(json.xuexiao!=''&&json.xuexiao){
