      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="考生号" prop="kaoshenghao">
          <el-input v-model="ruleForm.kaoshenghao" 
              placeholder="考生号" clearable  :readonly="ro.kaoshenghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考生号" prop="kaoshenghao">
              <el-input v-model="ruleForm.kaoshenghao" 
          ...
          <el-form-item class="input" label="考生姓名" prop="kaoshengxingming">
              <el-input v-model="ruleForm.kaoshengxingming" 
                placeholder="考生姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考生成绩" prop="kaoshengchengji">
          <el-input v-model="ruleForm.kaoshengchengji" 
              placeholder="考生成绩" clearable  :readonly="ro.kaoshengchengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考生成绩" prop="kaoshengchengji">
              <el-input v-model="ruleForm.kaoshengchengji" 
                placeholder="考生成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kaoshengxingming = true;
            continue;
	            	            ...
	            	            if(o=='kaoshengchengji'){
            this.ruleForm.kaoshengchengji = obj[o];
	    this.ro.kaoshengchengji = true;
            continue;
          }
	            	            if(o=='pingyu'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `kaoshengchengji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kaoshengchengjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
